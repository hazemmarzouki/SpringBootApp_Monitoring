...
public class DepartmentServiceImpl implements DepartmentService{
	...
	public Department updateDepartment(Long departmentId, Department department) {
		...
		if(Objects.nonNull(department.getDep_code()) && 
				 !"".equalsIgnoreCase(department.getDep_code())) {
					depDB.setDep_code(department.getDep_code());
				}
		
		if(Objects.nonNull(department.getDep_address()) && 
				 !"".equalsIgnoreCase(department.getDep_address())) {
